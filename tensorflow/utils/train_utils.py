...
def samples(split, args, N):  # TODO: Bug exist, this method is designed to test using N samples, however, it generate result of N+1 predicts, the iteration conditions are wrong.
    print("Sampling ...")
    args.training=False
...
'''
def predict_all_results(split, args):  # TODO: Bug exist, this method is designed to test using N samples, however, it generate result of N+1 predicts, the iteration conditions are wrong.
    print("Predicting ...")
